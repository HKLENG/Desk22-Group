...
For the survey on fitness groups, the survey site was chosen as the gym in Marlborough House, where Weifeng Dong lives. Most people here were fitness enthusiasts. For the survey of people who have no fitness habit, We decided to look for them from our friends.
...
**B) Result of the questionnaire for people who like exercise**
<div align=center>
...
On the basis of the above conclusions, we conducted an interview and concluded that it is necessary to provide users with sports suggestions which should be targeted and personalized. After discussion with the interviewees, we believe that the core function of the program can be set as: users can choose the exercise they want according to the body parts they want to exercise. Compared to existing mainstream applications, we find that this is innovative. Mainstream applications tend to focus on a single movement, specifying which muscles it helps.

In addition, 5 users mentioned the function of fitness plan, and 3 users mentioned the search function. The former is a good way to help develop exercise habits, while the latter allows users to look for the information they need more actively. Therefore although they are not innovative and they are lower priorities, we are also willing to try to achieve them.
...
- But it would be too confusing to save all the comments, so explanations and exercise suggestions appear only after the user selects one part.
- The fitness plan can be charted.
...
## The second user survey and results
...
According to the feedback, we completed the interaction flow chart. 
...
Then, we invited several people who had their own different opinions about the page design to work together on the prototype.
...
Here is the [demonstration of interactive prototypes](https://www.youtube.com/watch?v=2jcjkALqsa0) link.
